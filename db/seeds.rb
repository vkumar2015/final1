...
Hospital.delete_all
nuhealth = Hospital.create("hospname" => "NU Health Center" , "hcountry" => "United States" , "hstate" => "Illinois" , "hzip" => "60208" , "hcity" => "Evanston" , "hphotourl" => "http://www.007.com/wp-content/themes/007-2014/library/images/007_logo.png" , "hyear" => 1965 , "haddress" => "633 Emerson Street, Evanston IL 60208" , "htype" => "primary care" , "hphone" => "8474918100" , "hemail" => "abc@nuhealth.com" , "hurl" => "http://www.nuhs.northwestern.edu/evanston/default.aspx" , "hspecialization1" => "General Checkup" , "hspecialization2" => "Sports" , "hbeds" => 10 , "page_count" => 0 )
uchicagohealth = Hospital.create("hospname" => "UChicago Student Health Service" , "hcountry" => "United States" , "hstate" => "Illinois" , "hzip" => "60637" , "hcity" => "Chicago" , "hphotourl" => "http://healthcare.uchicago.edu/sites/healthcare.uchicago.edu/files/styles/homefeature/public/uploads/images/gargoyle.jpg" , "hyear" => 1975 , "haddress" => "860 East 59th Street, R100 Goldblatt Pavilion Entrance, Chicago, IL 60637" , "htype" => "critial care" , "hphone" => "7737024156" , "hemail" => "uchicagohealth" , "hurl" => "http://healthcare.uchicago.edu/" , "hspecialization1" => "STD" , "hspecialization2" => "Depression" , "hbeds" => 20 , "page_count" => 0 )
...
Ureviewhosp.create("user_id" => ben["id"] , "hosp_id" => nuhealth["id"] , "hosp_urating" => 4, "hosp_ucontent" => "Its the best." , "hosp_uphoto1" =>  "http://www.nuhs.northwestern.edu/evanston/images/nuhs2010a.jpg" , "hosp_ureco" => 1 )
